...
async function onPageLoad() {
    ...
    for (examRuleSubject of examRuleSubjectsJSON) {
        document.getElementById("SubjectId").value = examRuleSubject.SubjectId;
        await onSubjectChange();
        document.getElementById("SubtopicId").value = examRuleSubject.SubtopicId;
        await loadExamTypes();
        document.getElementById("ExamType").value = examRuleSubject.ExamType;
        await onExamTypeChange();
        document.getElementById("QuestionType").value = examRuleSubject.QuestionType;
        document.getElementById("QuestionDifficultyId").value = examRuleSubject.QuestionDifficultyId;
        document.getElementById("QuestionCount").value = examRuleSubject.QuestionCount;
    }
}
