...
public class AdminController : AdminBaseController
{
    ...
    public AdminController(IAdminService adminService, IMapper mapper, ICityService cityService, ISendMailService sendMailService, IEmailService emailService)
    {
    ...
    public async Task<IActionResult> Create(AdminAdminCreateVM model, IFormCollection collection)
    {
        ...
        await _sendMailService.SendEmailNewAdmin(addAdminResult.Data.Email, link);
