...
public class ExamRuleController : AdminBaseController
{
    ...
    [HttpGet]
    public async Task<SelectList> GetQuestionDifficulties(string examTypeId)
    {
        return new SelectList((await _questionDifficultyService.GetQuestionDifficultiesByQuestionTypeAsync(examTypeId)).Data, "Id", "Name");
    }
}