...
public interface IQuestionService
{
    ...
    /// <returns>Soru listeme modelini içerene sonuç nesnesi</returns>
    Task<IDataResult<List<QuestionListDto>>> GetAllByStateAndTrainerIdAsync(string trainerId, State state);
    ...
    Task<IDataResult<List<QuestionListDto>>> GetAllByExamRuleSubtopicAsync(Guid questionDifficultyId, int questionType, Guid subtopicId);
