...
public interface IQuestionDifficultyService
{
    ...
    /// <summary>
    /// Klasik soru tipi için soru zorluklarını getirir.
    /// </summary>
    /// <returns></returns>
    Task<IDataResult<List<QuestionDifficultyListDto>>> GetQuestionDifficultiesByQuestionTypeAsync(string questionType);
    /// <summary>
